"""
DrowsinessDetector - Main detection logic combining EAR + CNN + temporal analysis
"""
import base64
import numpy as np
import cv2
...
from .architectures import SimpleResNetEye
...
class DrowsinessDetector:
    ...
    def __init__(self, model_path=None):
        ...
        if model_path is None:
            ...
            model_path = Path(__file__).resolve().parents[2] / "models" / "eye" / "0.1.0" / "weights.pt"
    ...
    def update_temporal_state(self, ear, p_open):
        ...
        if self.calibrating and ear is not None and not closed_by_ear:
            ...
            if len(self.ear_open_vals) > 15 * self.fps:
